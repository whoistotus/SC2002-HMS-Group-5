...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // If user is logged in, show a simple menu
    ...
    private static void initialize() {
        ...
        try {
            loginManager.loadCredentials("SC2002_Assignment/data/staff.csv", "SC2002_Assignment/data/patients.csv");
        } catch (IOException e) {
    ...
    private static void handleLogin() {
        ...
        LoginResult result = loginManager.login(hospitalId, password);
        ...
        if (result.isSuccess()) {
            ...
            // Print current user info for testing
